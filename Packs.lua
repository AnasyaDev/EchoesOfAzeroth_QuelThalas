...
local SILVERMOON_MIDNIGHT = Pack {
    ...
    any = {
        ...
        T.MN_SilvermoonCityVoidA,
        T.MN_SilvermoonCityVoidB,
        T.MN_SilvermoonCityVoidC,
        T.MN_SilvermoonCityVoidD,
        T.MN_SilvermoonCityVoidE,
        T.MN_SilvermoonCityVoidF,
        T.MN_SilvermoonCityVoidG,
        T.MN_SilvermoonCityVoidI,
        T.MN_SilvermoonHordeA,
        T.MN_SilvermoonHordeB,
        T.MN_SilvermoonHordeC,
        T.MN_SilvermoonHordeH,
        T.MN_SilvermoonHordeVoidA,
        T.MN_SilvermoonHordeVoidB,
        T.MN_SilvermoonHordeVoidC,
        T.MN_SilvermoonHordeVoidD,
...
local EVERSONG_MIDNIGHT = Pack {
    ...
    any = {
        ...
        T.MN_LakeEldrendarF,
        T.MN_LakeEldrendarH,
        T.MN_LakeEldrendarVoidA,
        T.MN_LakeEldrendarVoidB,
        T.MN_LakeEldrendarVoidC,
    },
}
